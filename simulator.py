...
class Simulator(object):
	...
	logger.debug("Size of the gridworld {}".format(self.size))
		...
		#logger.debug("Agent {}".format(self.env.agent_states))
	...
	logger.debug("Road {}".format(self.pygame.draw.line(self.screen, self.road_color, (road[0][0] * self.env.block_size, road[0][1] * self.env.block_size), (road[1][0] * self.env.block_size, road[1][1] * self.env.block_size), self.road_width)))
